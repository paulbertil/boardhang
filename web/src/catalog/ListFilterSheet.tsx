    ...
    <Drawer open={open} onOpenChange={onOpenChange} showSwipeHandle>
      <DrawerContent>
        <DrawerHeader className="pb-2">
          ...
          <DrawerDescription>Show only problems in the lists you pick.</DrawerDescription>
        </DrawerHeader>

        <div className="max-h-[60vh] space-y-1 overflow-y-auto px-3 pb-4">
          {boardLists.map((list) => {
            ...
            return (
              <button
                ...
                className="flex w-full min-w-0 items-center gap-3 rounded-md px-3 py-2.5 text-left transition-colors hover:bg-accent/50"
              >
                <span
                  className={cn(
